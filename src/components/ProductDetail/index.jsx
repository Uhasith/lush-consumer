    ...
    <>
      <div className="flex flex-col items-center rounded-lg  md:flex-row md:max-w-full p-1">
        <img
          ...
          alt="product-img"
          className="w-full rounded-t-lg max-w-sm	 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg  ml-3"
        />
        <div className="flex flex-col justify-between pt-4 leading-normal sm:ml-0  md:ml-0 lg:ml-7">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex">
              ...
              <span className="mt-1">
                {product?.hasPromotion && <Flashsales />}
              </span>
            </div>
            ...
            <div className="flex">
              <button
                class="btn bg-[#097435] border-none normal-case rounded-lg h-[40px] w-[180px] gap-3"
