...
const Hero = () => {
  ...
  return (
    <div class="bg-white text-center hero-header-text">
      <div class="w-full">
...
<div className="mobile-searchbyproduct">
          ...
          <div className=" mt-3">
            <button
              class="btn gap-2 bg-[#097435] border-none normal-case rounded-lg h-[40px] w-full"
...
<div className="pt-[50px] flex justify-between desktop-searchbyproduct">
