    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          <div className="flex">
            <div className="flex flex-col py-2 gap-2 mobile-filtercard_title-p">
              <div className="flex">
                <div className="flex gap-2">
                  <a
                    className="text-xl text-[#262D33]"
                    href={`/products/${id}`}
                  >
                    {name}
                  </a>
                ...
                <div className="flex">{hasPromotion && <Flashsales />}</div>
              </div>
              <div className="flex">
                <div className="flex gap-2">
            ...
            <div
              className="flex items-right justify-center pl-8 float-right"
              style={{ width: "20%" }}
            >
